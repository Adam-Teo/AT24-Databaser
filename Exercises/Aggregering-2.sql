...
-- 'COUNT(*) As customers' hade också fungerat
...
-- Man bör igentligen undvika att göra sådanhär komplicerade stränglösningar i SQL 
-- bättre att göra dom ex python kod
SELECT 
